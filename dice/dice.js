...
(function () {
    ...
    loadPackage({ "files": [{ "filename": "/assets/dice.frag", "start": 0, "end": 529 }, { "filename": "/assets/dice.mtl", "start": 529, "end": 940 }, { "filename": "/assets/dice.obj", "start": 940, "end": 1889947 }, { "filename": "/assets/dice.vert", "start": 1889947, "end": 1891207 }], "remote_package_size": 1891207, "package_uuid": "624c3cca-07a9-4264-8ea2-58cd4769d791" })
})();
var moduleOverrides = {};
var key;
        ...
        LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
            ...
            var doXHR = function (from, to) {
                ...
                if (xhr.overrideMimeType) {
                    xhr.overrideMimeType("text/plain; charset = x - user - defined")}xhr.send(null);if (!(xhr.status >= 200 && xhr.status < 300 || xhr.status === 304)) throw new Error("Couldn't load " + url + ". Status: " + xhr.status);                    if (xhr.response !== undefined) { return new Uint8Array(xhr.response || []) } else { return intArrayFromString(xhr.responseText || "", true) }
                };
                var lazyArray = this;
